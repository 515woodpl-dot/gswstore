...
export function OrderStatusBadge({ status }: { status: OrderStatus }) {
  const meta = {
    ...
    draft:             { label: "Draft",            cls: "bg-slate-100 text-slate-600 ring-1 ring-slate-200" },
    awaiting_payment:  { label: "Awaiting Payment", cls: "bg-sky-50 text-sky-700 ring-1 ring-sky-200" },
    processing:        { label: "Processing",       cls: "bg-indigo-50 text-indigo-700 ring-1 ring-indigo-200" },
